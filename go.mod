...
require (
	...
	github.com/plgd-dev/device v1.2.2-0.20220621155359-92f9d570d7e2
	github.com/plgd-dev/go-coap/v2 v2.6.1-0.20220621090947-b61f9d901623
	github.com/plgd-dev/hub/v2 v2.4.5
