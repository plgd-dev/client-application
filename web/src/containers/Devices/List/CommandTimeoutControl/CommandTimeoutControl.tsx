...
import { Props, defaultProps } from './CommanTimeoutControl.types'

const { INFINITE, NS } = commandTimeoutUnits

const CommandTimeoutControl: FC<Props> = (props) => {
    const { defaultValue, defaultTtlValue, onChange, disabled, ttlHasError, onTtlHasError, isDelete, title } = {
        ...defaultProps,
        ...props,
    }
    ...
    const [inputValue, setInputValue] = useState<number>(convertAndNormalizeValueFromTo(defaultValue, NS, closestUnit))
...
CommandTimeoutControl.displayName = 'CommandTimeoutControl'
CommandTimeoutControl.defaultProps = defaultProps

export default CommandTimeoutControl
