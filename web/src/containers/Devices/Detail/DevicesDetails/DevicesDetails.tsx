...
import { DEVICE_PROVISION_STATUS_DELAY_MS, DEVICE_TYPE_OIC_WK_D, devicesStatuses } from '../../constants'
import { messages as t } from '../../Devices.i18n'
import { getColorByProvisionStatus, getDPSEndpoint, handleFetchResourceErrors } from '@/containers/Devices/utils'
...
const DevicesDetails: FC<Props> = memo(({ data, loading, isOwned, resources, deviceId }) => {
