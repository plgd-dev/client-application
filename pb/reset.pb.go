...
var file_github_com_plgd_dev_client_application_pb_reset_proto_goTypes = []any{
...
func file_github_com_plgd_dev_client_application_pb_reset_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_plgd_dev_client_application_pb_reset_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_github_com_plgd_dev_client_application_pb_reset_proto_msgTypes[1].Exporter = func(v any, i int) any {
