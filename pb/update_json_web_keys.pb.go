...
// 	protoc        v3.17.3
// source: github.com/plgd-dev/client-application/pb/update_json_web_keys.proto
...
func (x *UpdateJSONWebKeysResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
var file_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto_rawDesc = []byte{
...
var (
	file_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto_rawDescOnce sync.Once
	file_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto_rawDescData = file_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto_rawDesc
)

func file_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto_rawDescGZIP() []byte {
	file_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto_rawDescOnce.Do(func() {
		file_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto_rawDescData = protoimpl.X.CompressGZIP(file_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto_rawDescData)
	})
...
func file_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto_init() {
	if File_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto_goTypes,
		DependencyIndexes: file_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto_depIdxs,
		MessageInfos:      file_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto_msgTypes,
	}.Build()
	File_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto = out.File
	file_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto_rawDesc = nil
	file_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto_goTypes = nil
	file_github_com_plgd_dev_client_application_pb_update_json_web_keys_proto_depIdxs = nil
}
