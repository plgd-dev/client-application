...
var file_github_com_plgd_dev_client_application_pb_misc_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_github_com_plgd_dev_client_application_pb_misc_proto_goTypes = []interface{}{
	(*ResourceId)(nil), // 0: service.pb.ResourceId
	(*Content)(nil),    // 1: service.pb.Content
}
