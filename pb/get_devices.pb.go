...
const (
	OwnershipStatus_NEW   OwnershipStatus = 0
	OwnershipStatus_OWNED OwnershipStatus = 1
)
...
type GetDevicesRequest struct {
	...
	OwnershipStatusFilter OwnershipStatus `protobuf:"varint,2,opt,name=ownership_status_filter,json=ownershipStatusFilter,proto3,enum=service.pb.OwnershipStatus" json:"ownership_status_filter,omitempty"`
}
...
func (x *GetDevicesRequest) GetOwnershipStatusFilter() OwnershipStatus {
	if x != nil {
		return x.OwnershipStatusFilter
	}
	return OwnershipStatus_NEW
}
...
func (x *Device) Reset() {
	*x = Device{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_plgd_dev_client_application_pb_get_devices_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Device) Descriptor() ([]byte, []int) {
	return file_github_com_plgd_dev_client_application_pb_get_devices_proto_rawDescGZIP(), []int{1}
}
...
var file_github_com_plgd_dev_client_application_pb_get_devices_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x62, 0x1a, 0x34, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	,
...
var file_github_com_plgd_dev_client_application_pb_get_devices_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_github_com_plgd_dev_client_application_pb_get_devices_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_github_com_plgd_dev_client_application_pb_get_devices_proto_goTypes = []interface{}{
	(OwnershipStatus)(0),      // 0: service.pb.OwnershipStatus
	(*GetDevicesRequest)(nil), // 1: service.pb.GetDevicesRequest
	(*Device)(nil),            // 2: service.pb.Device
	(*Content)(nil),           // 3: service.pb.Content
}
var file_github_com_plgd_dev_client_application_pb_get_devices_proto_depIdxs = []int32{
	0, // 0: service.pb.GetDevicesRequest.ownership_status_filter:type_name -> service.pb.OwnershipStatus
	3, // 1: service.pb.Device.content:type_name -> service.pb.Content
...
func file_github_com_plgd_dev_client_application_pb_get_devices_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_plgd_dev_client_application_pb_get_devices_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Device); i {
			case 0:
				return &v.state
			case 1:
