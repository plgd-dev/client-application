...
type GetDevicesRequest_IPAddressVersion int32

const (
	GetDevicesRequest_IPV4 GetDevicesRequest_IPAddressVersion = 0
	GetDevicesRequest_IPV6 GetDevicesRequest_IPAddressVersion = 1
)

// Enum value maps for GetDevicesRequest_IPAddressVersion.
var (
	GetDevicesRequest_IPAddressVersion_name = map[int32]string{
		0: "IPV4",
		1: "IPV6",
	}
	GetDevicesRequest_IPAddressVersion_value = map[string]int32{
		"IPV4": 0,
		"IPV6": 1,
	}
)

func (x GetDevicesRequest_IPAddressVersion) Enum() *GetDevicesRequest_IPAddressVersion {
	p := new(GetDevicesRequest_IPAddressVersion)
	*p = x
	return p
}

func (x GetDevicesRequest_IPAddressVersion) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GetDevicesRequest_IPAddressVersion) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_plgd_dev_client_application_pb_get_devices_proto_enumTypes[1].Descriptor()
}

func (GetDevicesRequest_IPAddressVersion) Type() protoreflect.EnumType {
	return &file_github_com_plgd_dev_client_application_pb_get_devices_proto_enumTypes[1]
}

func (x GetDevicesRequest_IPAddressVersion) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GetDevicesRequest_IPAddressVersion.Descriptor instead.
func (GetDevicesRequest_IPAddressVersion) EnumDescriptor() ([]byte, []int) {
...
type GetDevicesRequest struct {
	...
	OwnershipStatusFilter []GetDevicesRequest_OwnershipStatusFilter `protobuf:"varint,2,rep,packed,name=ownership_status_filter,json=ownershipStatusFilter,proto3,enum=service.pb.GetDevicesRequest_OwnershipStatusFilter" json:"ownership_status_filter,omitempty"`
	...
	MulticastIpVersionFilter []GetDevicesRequest_IPAddressVersion `protobuf:"varint,4,rep,packed,name=multicast_ip_version_filter,json=multicastIpVersionFilter,proto3,enum=service.pb.GetDevicesRequest_IPAddressVersion" json:"multicast_ip_version_filter,omitempty"`
	...
	MulticastTimeout uint32 `protobuf:"varint,5,opt,name=multicast_timeout,json=multicastTimeout,proto3" json:"multicast_timeout,omitempty"`
	...
	EndpointFilter []string `protobuf:"bytes,6,rep,name=endpoint_filter,json=endpointFilter,proto3" json:"endpoint_filter,omitempty"`
}
...
func (x *GetDevicesRequest) GetMulticastIpVersionFilter() []GetDevicesRequest_IPAddressVersion {
	if x != nil {
		return x.MulticastIpVersionFilter
	}
	return nil
}

func (x *GetDevicesRequest) GetMulticastTimeout() uint32 {
	if x != nil {
...
func (x *GetDevicesRequest) GetEndpointFilter() []string {
	if x != nil {
...
var file_github_com_plgd_dev_client_application_pb_get_devices_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x62, 0x22, 0xdc, 0x03, 0x0a, 0x11, 0x47, 0x65,
	...
	0x28, 0x08, 0x52, 0x08, 0x75, 0x73, 0x65, 0x43, 0x61, 0x63, 0x68, 0x65, 0x12, 0x6b, 0x0a, 0x17,
	0x6f, 0x77, 0x6e, 0x65, 0x72, 0x73, 0x68, 0x69, 0x70, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x33, 0x2e,
	...
	,
...
var file_github_com_plgd_dev_client_application_pb_get_devices_proto_goTypes = []interface{}{
	...
	(GetDevicesRequest_IPAddressVersion)(0),      // 1: service.pb.GetDevicesRequest.IPAddressVersion
...
var file_github_com_plgd_dev_client_application_pb_get_devices_proto_depIdxs = []int32{
	...
	1, // 1: service.pb.GetDevicesRequest.multicast_ip_version_filter:type_name -> service.pb.GetDevicesRequest.IPAddressVersion
