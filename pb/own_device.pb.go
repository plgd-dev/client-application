...
var file_github_com_plgd_dev_client_application_pb_own_device_proto_goTypes = []any{
...
func file_github_com_plgd_dev_client_application_pb_own_device_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_plgd_dev_client_application_pb_own_device_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_github_com_plgd_dev_client_application_pb_own_device_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_github_com_plgd_dev_client_application_pb_own_device_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_github_com_plgd_dev_client_application_pb_own_device_proto_msgTypes[3].Exporter = func(v any, i int) any {
