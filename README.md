...
| `apis.coap.tls.preSharedKey.subjectId` | UUID | `Provides an identifier for client applications for establishing TLS connections or for devices that are set as owner devices` | `""` |
